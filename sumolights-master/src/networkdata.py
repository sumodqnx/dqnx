...
class NetworkData:
    ...
    def get_net_data(self):
        ret = {'lane':self.lane_data, 'edge':self.edge_data, 'origin':self.find_origin_edges(), 'destination':self.find_destination_edges(), 'node':self.node_data, 'inter':self.intersection_data}
        return ret
