...
def parse_cl_args():
    ...
    parser.add_argument("-tsc", type=str, default='websters', dest='tsc', help='traffic signal control algorithm, default:websters; options:sotl, maxpressure, dqn, ddpg, dqnx'  )
    ...
    parser.add_argument("-scale", type=float, default=1.5, dest='scale', help='check the vehiclegen.py for details')
    ...
    parser.add_argument("-offset", type=float, default=0.3, dest='offset', help='max sim offset fraction of total sim length, default: 0.3')

    #tianxin: incident args
    parser.add_argument("-incident", default=False, action='store_true', dest='incident', help='disable incident generation, default: False')

    #shared tsc params (uniform)
    ...
    parser.add_argument("-hidden_act", type=str, default='relu', dest='hidden_act', help='neural network hidden layer activation, default: relu')
    parser.add_argument("-n_layers", type=int, default=3, dest='n_layers', help='neural network number of hidden layers, default: 3')
    parser.add_argument("-n_hidden", type=int, default=64, dest='n_hidden', help='neural network number of nodes for each hidden layer, default: 64')
